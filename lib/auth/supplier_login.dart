...
import 'package:thebrandsapp/minor_screens/forgot_password.dart';
...
class _SupplierLoginState extends State<SupplierLogin> {
  ...
  setUserId(User user) {
    context.read<IdProvider>().setSupplierId(user);
  }
      ...
      try {
        ...
        if (await AuthRepo.checkEmailVerification()) {
          ...
          MyMessageHandler.showSnackBar(
              _scaffoldKey, 'please check your inbox For Email Verification');
          setState(() {
            processing = false;
