                              ...
                              Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Center(
                                        child: Text(widget.items['maincateg'], style: TextStyle(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 16),)),
                                  )
                                ],
                              ),
                              Column(
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                        ...
                                        borderRadius:
                                            BorderRadius.circular(10)),
                                    child: Center(
                                        child: Text(widget.items['subcateg'], style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w500),)),
                                  )
                                ],
                              ),
                            ],
